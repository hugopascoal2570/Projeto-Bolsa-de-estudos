...
<?php $__env->startSection('title', 'Adicinando responsável'); ?>
...
<form action="<?php echo e(route('etapaDois')); ?>" method="POST" id="regForm" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\estudoLaraval\ProjetoBolsa\ProjetoBolsa\resources\views/site/addResponse.blade.php ENDPATH**/ ?>