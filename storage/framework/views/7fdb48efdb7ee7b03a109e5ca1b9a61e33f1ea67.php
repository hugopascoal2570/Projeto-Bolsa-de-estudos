                            ...
                            <div class="logo">
                                <div class="col-xl-6 col-lg-7">
                                    <div class="main-menu  d-none d-lg-block">
                                        <nav>
                                            <ul id="navigation">
                                                <li><a class="active" href="<?php echo e(url('/login')); ?>">Login</a>
                                                </li>
                            ...
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a class="active" href="<?php echo e(url('/cursos')); ?>">Cursos</a></li>
                                        <li><a class="active" href="<?php echo e(url('/resultado')); ?>">Cursos</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\estudoLaraval\ProjetoBolsa\ProjetoBolsa\resources\views/site/layout.blade.php ENDPATH**/ ?>